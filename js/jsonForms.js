var forms = {
	generalForm: function(){
		return '<h1>General</h1><div class="row_form_general"><label>Name</label><input id="inptName" type="text"/></div><div class="row_form_general"><label>Email</label><input id="inptEmail" type="text"/></div><div class="row_form_general"><label>Subject</label><input id="inptSubject" type="text"/></div><div class="row_form_textarea"><label>Messaje</label><textarea id="textareaFormGeneral" class="textareaForm"></textarea><button class="btn btn-warning btn-lg btnSubmit" id="btnSubmitGeneral">Submit</button></div>';
	},
	showcaseForm: function(){
		return '<h1>Showcase</h1><div class="row_form_general"><label>Name</label><input id="inptName" type="text"/></div><div class="row_form_general"><label>Email</label><input id="inptEmail" type="text"/></div><div class="row_form_general"><label>Subject</label><input id="inptSubject" type="text"/></div><div class="rowFormCalendar"><div class="colFormCalendar"><div id="datepicker"></div></div><div class="colFormCalendar"><div class="row_form_general"><label style="width:100%;">Choose one day</label></div><div class="row_form_general"><input type="text" id="inptDateShowcase" disabled="disabled"/></div><div class="row_form_general" > <label style="width:100%">A brief explanation</label> </div><div class="row_form_general"> <textarea class="textareaForm" id="textareaFormShowcase"></textarea> </div></div></div> <button class="btn btn-warning btn-lg btnSubmit" id="btnSubmitShowcase">Submit</button>';
	},
	sendDemo: function(){
